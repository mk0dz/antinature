# test_antinature_applications.py
...
from antinature.specialized.visualization import visualize_annihilation_density
from antinature.specialized.visualization import plot_wavefunction
