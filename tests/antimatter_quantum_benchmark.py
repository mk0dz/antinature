...
try:
    ...
    from qantimatter.qiskit_integration import AntimatterQuantumSolver
except ImportError:
    # Fallback to direct import
    from qantimatter.qiskit_integration.qantimatter_solver import AntimatterQuantumSolver
