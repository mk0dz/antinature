...
try:
    ...
    HAS_QISKIT = False
    print(f"Warning: Qiskit not available: {str(e)}. Ansatz functionality will be limited.")
...
class AntinatureAnsatz:
    ...
    @staticmethod
    def anti_hydrogen_ansatz(n_orbitals: int = 1, reps: int = 3, 
                           electronic_reps: int = 2) -> QuantumCircuit:
        """
    ...
    @staticmethod
    def positronium_molecule_ansatz(reps: int = 3, use_advanced: bool = True) -> QuantumCircuit:
        """
            ...
            if use_advanced and r < reps - 1:
                ...
                for i in range(4):
                    for j in range(i+1, 4):
                        if (i, j) not in [(0, 2), (1, 3), (0, 1), (2, 3), (0, 3), (1, 2)]:
    ...
    @staticmethod
    def create_hardware_efficient_ansatz(n_qubits: int, reps: int = 2, 
    ...
    @staticmethod
    def two_particle_ansatz(particle_type: str = 'both', reps: int = 2) -> QuantumCircuit:
        """
    ...
    def get_specialized_ansatz(system_name: str, **kwargs) -> QuantumCircuit:
        ...
        **kwargs : dict
        ...
        if system_name.lower() == 'positronium':
            ...
            return AntinatureAnsatz.positronium_ansatz(reps=reps, entanglement=entanglement)
        
        elif system_name.lower() == 'anti_hydrogen' or system_name.lower() == 'antihydrogen':
            ...
            return AntinatureAnsatz.anti_hydrogen_ansatz(
                ...
                reps=reps, 
                electronic_reps=electronic_reps
            )
        
        elif system_name.lower() == 'positronium_molecule' or system_name.lower() == 'ps2':
        ...
        elif system_name.lower() == 'anti_helium' or system_name.lower() == 'antihelium':
            ...
            return AntinatureAnsatz.two_particle_ansatz(particle_type=particle_type, reps=reps)
        
        else:
            # Default to hardware efficient ansatz
            n_qubits = kwargs.get('n_qubits', 4)
            entanglement = kwargs.get('entanglement', 'linear')
            print(f"No specialized ansatz for '{system_name}'. Using hardware-efficient ansatz.")
